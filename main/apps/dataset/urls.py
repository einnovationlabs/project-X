...
urlpatterns = [
    ...
    path("files.delete/<int:user_id>/<int:file_id>",views.delete_file, name="delete_file"),
    ...
    path("bookmarks.create/<int:user_id>/", views.create_bookmark, name="create_bookmark"),

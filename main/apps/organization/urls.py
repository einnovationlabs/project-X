...
urlpatterns = [
    ...
    path('orgs/add-org-member/<int:admin_id>/', views.add_org_member, name = "add_org_member"),
    path('orgs/remove-org-member/<int:admin_id>/', views.remove_org_member, name = "remove_org_member"),

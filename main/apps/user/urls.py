...
urlpatterns = [
    path('users.create', views.create_user, name='create_user'),
     path('users.listForSuperAdmin', views.users_list_super_admin, name = "users_list_super_admin"),
    ...
    path('users.roles.update/<int:user_id>/', views.update_user_role, name='update_user_roles'),

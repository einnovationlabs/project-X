...
urlpatterns = [
    ...
    path('datasets/get-all/', views.get_all_datasets, name = "get_all_datasets"),
    path('files/delete/<int:dataset_id>/', views.delete_file, name = "delete_file"),
    path('files/<int:dataset_id>/', views.create_file, name = "create_file"),
